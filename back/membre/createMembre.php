                    ...
                    <form class="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-6">
                                ...
                                <input class="form-control" type="text" name="prenomMemb" maxlength="80" value="<?= $prenomMemb ?>" placeholder="John" autofocus="autofocus" />
                            </div>

                            <div class="form-group mb-3 col-6">
                                <label for="nomMemb"><b>Nom :</b></label>
                                <input class="form-control" type="text" name="nomMemb" maxlength="80" value="<?= $nomMemb ?>" placeholder="Doe" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-6">
                                ...
                                <input class="form-control" type="text" name="pseudoMemb" maxlength="80" value="<?= $pseudoMemb ?>" placeholder="JohnD33" />
                            </div>
